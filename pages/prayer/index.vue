...
<template>
  <div class="container pt-20 md:pt-24">
    <!-- Header -->
    <div
      class="mb-6 flex flex-col items-center space-y-8 rounded-xl bg-gradient-to-br from-rose-700 to-rose-500 p-4 sm:pb-10 sm:pt-8 md:mb-10 dark:from-slate-700/50 dark:to-slate-600/60"
    >
      <Icon
