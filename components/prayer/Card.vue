...
<template>
  <div
    class="group rounded-lg border border-gray-300/70 transition-all duration-150 ease-linear hover:!border-rose-600 hover:shadow-[0px_0px_20px_#E7E7E7] dark:border-gray-700 hover:dark:shadow-[0px_0px_20px_#181616]"
  >
    <!-- Header -->
    <div
    ...
    >
      ...
      <div v-if="prayer.arab">
        ...
        <p
          class="mb-3 text-sm !leading-6 tracking-wide text-rose-800 md:text-base md:!leading-7 dark:text-white"
        >
          {{ prayer.latin }}
        </p>
