        ...
        >
          ...
          <div class="p-4">
            ...
            <div class="relative mb-2 flex w-full items-center">
              <!-- Play & Pause button -->
              <div
                class="relative mr-2 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-rose-600 text-2xl text-white md:absolute md:inset-x-0 md:mx-auto md:h-12 md:w-12"
                role="button"
                @click="togglePlay"
              >
...
#slider {
  ...
  background: linear-gradient(
    to right,
    theme('colors.rose.500') var(--progress),
...
#slider::-webkit-slider-thumb {
  @apply appearance-none w-3 h-3 bg-rose-600 rounded-full border-none transition-all ease-in-out duration-200;
}
...
#slider::-webkit-slider-thumb:hover {
  @apply shadow-[0_0_0_10px] shadow-rose-300/30;
}
