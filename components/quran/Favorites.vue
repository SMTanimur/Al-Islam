...
<template>
  <div class="mb-12">
    <p
      class="mb-3 border-l-4 border-rose-600 pl-2 text-base font-semibold text-yami dark:text-slate-200"
    >
      Surah Favorit
    </p>
    ...
    >
      <NuxtLink
        ...
        class="group min-w-[200px] max-w-[200px] cursor-pointer rounded-lg border border-gray-300/70 p-3 hover:border-rose-600 hover:shadow-surah-card dark:border-gray-700 dark:hover:border-rose-600 dark:hover:shadow-surah-card-dark"
      >
        <div class="mb-3 flex items-center justify-between">
          ...
          <UTooltip text="Hapus dari favorit">
            <Icon
              ...
              class="z-10 text-xl text-rose-600"
